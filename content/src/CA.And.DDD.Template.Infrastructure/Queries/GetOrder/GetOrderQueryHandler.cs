...
//        public GetOrderQueryHandler(IAppDbContext appDbContext, ICacheService cacheService, IOrderRepository orderRepository)
//        {
...
//            //order.CalculateTotalAmount(new Money(await _orderRepository.GetTotalSpentInLast31DaysAsync(order.CustomerId)));
